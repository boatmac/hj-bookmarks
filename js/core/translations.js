...
const TRANSLATIONS = {
    zh: {
        ...
        helpSync1: '云端服务模式支持标准 WebDAV 和 Koofr。',
        ...
        syncSettings: '加密同步设置',
        syncMethod: '同步方式',
        syncMethodHint: '选择远端服务或桌面云盘管理的本地目录',
        remoteServiceMode: '云端服务（WebDAV / Koofr）',
        localFolderMode: '本地同步目录（OneDrive / Google Drive / Syncthing）',
    ...
    en: {
        ...
        helpSync1: 'Cloud service mode supports standard WebDAV and Koofr.',
        ...
        syncMethodHint: 'Choose a remote service or a folder managed by a desktop cloud drive',
        remoteServiceMode: 'Cloud service (WebDAV / Koofr)',
        localFolderMode: 'Local sync folder (OneDrive / Google Drive / Syncthing)',
