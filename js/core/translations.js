...
const TRANSLATIONS = {
    zh: {
        ...
        helpSync1: '填写远端同步地址时，应用会自动选择兼容的连接方式。',
        ...
        disabledLabel: '关闭',
        syncMethod: '同步方式',
        syncMethodHint: '选择远端同步地址或桌面同步软件管理的本地目录',
        remoteServiceMode: '远端同步地址',
    ...
    en: {
        ...
        helpSync1: 'When you enter a remote sync address, the app selects a compatible connection method automatically.',
        ...
        remoteSyncLocation: 'Remote sync address',
        ...
        syncMethodHint: 'Choose a remote sync address or a local folder managed by desktop sync software',
        remoteServiceMode: 'Remote sync address',
