...
const TRANSLATIONS = {
    zh: {
        ...
        helpBackup3: '“从备份恢复”可预览快照，并选择合并或替换当前内容。',
        ...
        restoreBackupMenuHint: '预览最新备份或历史快照后安全恢复',
        ...
        backupRestoreMerge: '合并恢复',
        backupRestoreMergeHint: '保留当前内容，只补回缺少的文件夹和书签。',
        backupRestoreReplace: '替换恢复',
        backupRestoreReplaceHint: '将当前书签恢复为所选快照的状态。',
        backupRestoreReplaceWarning: '替换前会在所选目录中创建一份紧急备份；当前快照中不存在的项目会生成删除记录。',
        backupRestoreMergeAction: '合并所选备份',
        backupRestoreReplaceAction: '替换为所选备份',
        ...
        backupRestoreReplaceConfirm: '确定用所选备份替换当前书签吗？替换前会自动创建紧急备份。',
        ...
        backupRestoreMerged: ({ count, skipped }) => `已合并恢复 ${count} 项${skipped ? `，跳过 ${skipped} 个已有书签` : ''}`,
    ...
    en: {
        ...
        helpBackup3: '“Restore from backup” previews snapshots and can merge or replace current content.',
        ...
        restoreBackupMenuHint: 'Preview the latest backup or a history snapshot before restoring',
        ...
        backupRestoreMerge: 'Merge restore',
        backupRestoreMergeHint: 'Keep current content and restore only missing folders and bookmarks.',
        backupRestoreReplace: 'Replace restore',
        backupRestoreReplaceHint: 'Restore current bookmarks to the selected snapshot.',
        backupRestoreReplaceWarning: 'An emergency backup is created in the selected folder first. Items absent from the snapshot receive deletion records.',
        backupRestoreMergeAction: 'Merge selected backup',
        backupRestoreReplaceAction: 'Replace with selected backup',
        ...
        backupRestoreKilobytes: ({ count }) => `${count} KB`,
        backupRestoreMegabytes: ({ count }) => `${count} MB`,
        backupRestoreReplaceConfirm: 'Replace current bookmarks with the selected backup? An emergency backup is created first.',
        ...
        backupRestoreMerged: ({ count, skipped }) => `Merged ${count} item${count === 1 ? '' : 's'}${skipped ? `; skipped ${skipped} existing bookmark${skipped === 1 ? '' : 's'}` : ''}`,
